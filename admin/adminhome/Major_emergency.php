       	...
       	<div class="page-wrapper">
            	...
            	<div class="Container-fluid">
           			...
           			<div class="container p-5 my-5 bg-white  shadow table-responsive-sm" >
							...
							<span class="counter pull-right"><h2 style="color: #26c6da;">LIST OF MAJOR EMERGENCY</h2></span>
							<table class="table table-hover table-bordered results">
							  <thead>
							    <tr>
							      <th >Ref #</th>
							      <th class="col-md-3 col-xs-3">Name</th>
							      <th class="col-md-3 col-xs-3">Message</th>
							      <th class="col-md-3 col-xs-3">Coordinates</th>
							      ...
							      <th class="col-md-3 col-xs-3">Time</th>
							    	 ...
							    	 <tbody>
							    	 	...
							    	 	<?php
							    	 	$getemergency = mysqli_query($conn, "SELECT * FROM emergency");
							    	...
							    	<tr>
								      ...
								      <td><?php echo $e['resident_name'];?></td>
								      <td><?php echo $e['message'];?></td>
								      <td><?php echo "Latitude: ".$e['mylat'].'</br>'."Longitude: ".$e['mylong'] ;?></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form action="process.php" Method="POST">
    	...
    	<input type="text" class="form-control"  placeholder="Enter your Complaint Title" name="complain_name" required>

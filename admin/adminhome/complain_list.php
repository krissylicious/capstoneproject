							    ...
							    <tr>
							      ...
							      <th class="col-md-3 col-xs-3">Action</th>
							    	 ...
							    	 <tbody>
							    	 	...
							    	 	<?php
							    	 	$getcomplain = mysqli_query($conn, "SELECT * FROM complain_report");

							    	 	while ($complains = mysqli_fetch_array($getcomplain)) {
							    	 		
							    	 	
							    	 	?>

							    	<tr>
							    	  <th scope="row"><?php echo $complains['id'];?></th>
								      <td><?php echo $complains['complain_title'];?></td>

								      <td style="font-size: 20px; text-align: center; color:#008081;"> 

								      <a	href="delete.php?id=<?php echo $complains['id'];?>" onclick="return confirm ('Do you want to delete this item?')"><i class="mdi me-2 mdi-delete-circle" >DELETE</i></a>

								      </td>

								      <td style="font-size: 20px; text-align: center; color:#26c6da;">

								      	<a href="" data-bs-toggle="modal" data-bs-target="#p<?php echo $complains['id'];?>"><i class="mdi me-2 mdi-pencil" >UPDATE</i></a>


								      	<!-- Update of complaints -->
										<div class="modal" id="p<?php echo $complains['id'];?>">
										  <div class="modal-dialog modal-sm">
										    <div class="modal-content">
										      ...
										      <!-- Modal Header -->
										      <div class="modal-header">
										        <h4 class="modal-title">UPDATE COMPLAIN</h4>
										        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
										      </div>
...
<div class="modal fade" id="myModal1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" >close</button>
        <input type="submit" class="btn text-white" value="Create" name="complain_title" style="background-color:#26c6da">
      </form>
      </div>
  </div>
<!----End of modal----->

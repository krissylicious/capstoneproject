...
$message = "Hi, Ako po si {$name} humihingi ng tulong dahil sa merong naaksidente sa area na ito , Latitude: {$lat} Longitude: {$long}";
...
if(curl_errno($ch)) {
  ...
  $insertemergency=mysqli_query($conn, "INSERT INTO emergency VALUES('0', '$name', 'PCDR', '$message', '$lat', '$long', '$date', '$time')");
  ?>
  <script >
    alert("Message Sent!");
    window.location.href="emergencybutton.php";

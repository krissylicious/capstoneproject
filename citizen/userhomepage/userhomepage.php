    ...
    <div class="card-body">
            <div class="card" >
                <div class="card-header">
                    <a class="btn" data-bs-toggle="modal" data-bs-target="#agencies1">
                    Accidents/Emergencies (Iloilo City Emergency Respondents)
                    </a>
                </div>
                
                    <div class="modal fade" id="agencies1" style="margin-top: 200px">
                ...
                <div class="card">
                    <div class="card-header">
                        <a class="btn" data-bs-toggle="modal" data-bs-target="#agencies2">
                        BFP Search & Rescue
                        </a>
                    </div>
                  
                        <div class="modal fade" id="agencies2" style="margin-top: 200px">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <!-- Modal Header -->
                                    <div class="modal-header" >
                ...
                <div class="card">
                    <div class="card-header">
                        <a class="btn"  data-bs-toggle="modal" data-bs-target="#agencies3">
                        Red Cross
                        </a>
                    </div>
                    
                       
                           <div class="modal fade" id="agencies3" style="margin-top: 200px">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <!-- Modal Header -->
                                    <div class="modal-header" >
                ...
                <div class="card">
                    <div class="card-header">
                        <a class="btn" data-bs-toggle="modal" data-bs-target="#agencies4">
                        PSTMO Public Safety
                        </a>
                    </div>
                        <div class="modal fade" id="agencies4" style="margin-top: 200px">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <!-- Modal Header -->
                                    <div class="modal-header" >
                ...
                <div class="card">
                    <div class="card-header">
                        <a class="btn" data-bs-toggle="modal" data-bs-target="#agencies5">
                        TMTRO Traffic
                        </a>
                    </div>
                    
                       <div class="modal fade" id="agencies5" style="margin-top: 200px">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <!-- Modal Header -->
                                    <div class="modal-header" >
                ...
                <hr></hr>
                <h3 class="text-center">FIRE STATIONS</h3>
                <div class="card">
                    <div class="card-header">
                        <a class="btn" data-bs-toggle="modal" data-bs-target="#agencies6">
                        Arevalo
                        </a>
                    </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseSeven" class="collapse" data-bs-parent="#accordion">
                        <div class="card-body">
                            <li class="list-group-item">#337 7790</li>
                            <li class="list-group-item">#337 4989</li>
                        </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div id="collapseEight" class="collapse" data-bs-parent="#accordion">
                        <div class="card-body">
                            <li class="list-group-item">#329 5700</li>
                        </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div id="collapseNine" class="collapse" data-bs-parent="#accordion">
                        <div class="card-body">
                            <li class="list-group-item">#323 5139</li>
                        </div>
                    </div>
                </div>
            </div>
